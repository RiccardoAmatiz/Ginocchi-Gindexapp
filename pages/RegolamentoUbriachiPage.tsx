...
const RegolamentoUbriachiPage: React.FC = () => {
    ...
    const rules = [
        { title: "Regola Aurea: meglio un figlio in guerra che l’alcol per terra", imageName: "RU1.webp", caption: "Se rovesci un gin tonic (tuo o di un avversario) hai perso." },
        { title: "Preparazione", imageName: "RU4.webp", caption: "Scegli due bottiglie di GINocchi e mettile sul tavolo, una per giocare e l’altra per fare un gin tonic. Prepara il gin tonic e scansiona il QR code del tuo personaggio in campo per avere tutto sotto controllo." },
        { title: "Inizio partita", imageName: "RU3.webp", caption: "Brinda insieme ai tuoi avversari urlando “Vaffanculo miserabili!”. Il primo a poggiare il bicchiere sul tavolo inizierà la partita." },
        { title: "Movimento", imageName: "RU5.webp", caption: "Lancia il dado e muoviti sul tabellone. Se dopo esserti spostato non attacchi, bevi." },
        { title: "Attacco", imageName: "RU6.webp", caption: "Lancia il dado, trova l’attacco corrispondente nella scheda di gioco e gridalo al tuo avversario!" },
        { title: "Difesa", imageName: "RU7.webp", caption: "Se vieni attaccato, lancia un dado. Se ottieni lo stesso numero del dado di attacco, danno ed effetto verranno inflitti al tuo avversario." },
        { title: "Interazione", imageName: "RU8.webp", caption: <>Sfrutta debolezze e resistenze: se il tuo personaggio si posiziona sulla casella della propria tipologia, ottieni un bonus +1 in attacco e in difesa.<br/>Inoltre: Fruttato +1 &gt; Erbaceo +1 &gt; Speziato +1 &gt; Fruttato. I GINocchi bilanciati, invece, sono neutrali.</> },
        { title: "Vittoria & Co.", imageName: "RU9.webp", caption: "Sconfiggendo un avversario, vincerai la sua bottiglia di GINocchi in campo. L’ultimo superstite vince la partita. Se sei morto, ma hai anche finito il tuo gin tonic, puoi farne un altro e rientrare in campo con un altra bottiglia di GINocchi a tua disposizione, a tuo rischio e pericolo!" },
    ];

  return (
    <div className="py-6 px-2">
      <img 
        src="/images/regolamento_per_ubriachi.webp" 
