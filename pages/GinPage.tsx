...
const GinPage: React.FC = () => {
  ...
  return (
    <>
      <img src="/images/gin/gin1.webp" alt="Il Gin dei Ginocchi" className="w-full" />
      
      <div className="py-6 max-w-3xl mx-auto text-gray-200 font-roboto-mono px-4">
        ...
        <section className="mb-12 space-y-4 leading-relaxed text-lg">
          <h2 className="text-3xl font-rubik font-bold mb-4 text-white">Perché bere <strong className="font-bold">GIN</strong>occhi? Perché è buonissimo!</h2>
